...
def run_topGO(gene_vals, gene_to_go, go_term_type, gene_pval, go_pval,
    ...
    print "go_term_type="+str(go_term_type)
    print "gene vals="+str(gene_vals)
    print "gene_to_go"+str(gene_to_go)
...
def parse_go_map_file(in_handle, genes_w_pvals):
    ...
    for line in in_handle:
        parts = line.split("\t")
        gene_id = parts[0]        #gene id 'AT1G71130'
        go_id = parts[1].strip()  #locus
        #print 'gene_id ='+str(gene_id)
